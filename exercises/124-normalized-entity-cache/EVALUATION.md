# Avaliação: Cache normalizado de entidades
    ...
    Avaliar navegação, delimitação de responsabilidade e implementação de gerenciamento de estado. O caminho da fachada até a política atravessa limites explícitos da aplicação; alterar arquivos não relacionados deve ser evitado.
    ...
    **Armadilha:** criar uma segunda implementação fora do fluxo real, alterar a fachada para contornar a arquitetura ou confundir módulos plausíveis com arquivos que precisam ser modificados.
    ...
    | --- | --- | ---: | --- | --- |
    | C01 | minimum | 3 | atualiza entidade | `C01` |
| C02 | minimum | 2 | insere entidade | `C02` |
| C03 | minimum | 2 | ordena por ID | `C03` |
| C04 | intermediate | 2 | vazio aceita primeira | `C04` |
| C05 | desired | 1 | valor vazio é mantido | `C05` |

# Motor de preços legado

Este repositório simula um motor legado de promoções. Regras devem ser isoladas e aplicadas em ordem explícita sobre o valor corrente.

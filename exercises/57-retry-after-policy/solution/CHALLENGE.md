# Desafio: Retry-After
    ...
    Interpretar delta-seconds e limitar espera máxima.

    ## Pedido

    Complete `Policy.Evaluate` de acordo com o contrato descrito pelo domínio e preserve a assinatura pública. Investigue os casos de borda coerentes com **resiliência HTTP** e acrescente testes de regressão quando necessário.

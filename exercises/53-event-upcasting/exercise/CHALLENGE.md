# Desafio: Upcasting de eventos

    ## Contexto

    Converter versões antigas para o modelo atual preservando significado.

    ## Pedido

    Complete `Policy.Evaluate` de acordo com o contrato descrito pelo domínio e preserve a assinatura pública. Investigue os casos de borda coerentes com **compatibilidade de schema** e acrescente testes de regressão quando necessário.

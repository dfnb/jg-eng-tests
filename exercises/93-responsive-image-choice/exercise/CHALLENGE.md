# Desafio: Imagem responsiva

    ## Contexto

    Escolher menor candidato suficiente para viewport e DPR.

    ## Pedido

    Complete `evaluate` preservando sua exportação e integre a decisão ao componente quando isso for relevante. Considere os limites naturais de **performance web**, não somente o caminho mais comum.

# Desafio: Ordenação de eventos

    ## Contexto

    Aplicar somente próxima versão, ignorar duplicata e detectar gap.

    ## Pedido

    Complete `Policy.Evaluate` de acordo com o contrato descrito pelo domínio e preserve a assinatura pública. Investigue os casos de borda coerentes com **mensageria** e acrescente testes de regressão quando necessário.

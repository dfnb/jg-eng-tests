# Suíte de testes instável

Este repositório simula uma suíte de autenticação que falha intermitentemente. Tokens dependem de relógio e gerador de identificadores controláveis.

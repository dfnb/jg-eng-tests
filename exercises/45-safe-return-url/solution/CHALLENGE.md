# Desafio: Return URL seguro

    ## Contexto

    Aceitar somente caminho local absoluto sem barra dupla ou esquema.

    ## Pedido

    Complete `Policy.Evaluate` de acordo com o contrato descrito pelo domínio e preserve a assinatura pública. Investigue os casos de borda coerentes com **segurança web** e acrescente testes de regressão quando necessário.

# Avaliação: Alocação de remessas
    ...
    Avaliar navegação, delimitação de responsabilidade e implementação de algoritmos de domínio. O caminho da fachada até a política atravessa limites explícitos da aplicação; alterar arquivos não relacionados deve ser evitado.
    ...
    **Armadilha:** criar uma segunda implementação fora do fluxo real, alterar a fachada para contornar a arquitetura ou confundir módulos plausíveis com arquivos que precisam ser modificados.
    ...
    | --- | --- | ---: | --- | --- |
    | C01 | minimum | 3 | menor distância vence | `C01` |
| C02 | minimum | 2 | estoque insuficiente é ignorado | `C02` |
| C03 | minimum | 2 | ID desempata | `C03` |
| C04 | intermediate | 2 | nenhum candidato | `C04` |

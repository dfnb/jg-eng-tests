# Avaliação: Histórico de undo e redo
    ...
    Avaliar navegação, delimitação de responsabilidade e implementação de estado reversível. O caminho da fachada até a política atravessa limites explícitos da aplicação; alterar arquivos não relacionados deve ser evitado.
    ...
    **Armadilha:** criar uma segunda implementação fora do fluxo real, alterar a fachada para contornar a arquitetura ou confundir módulos plausíveis com arquivos que precisam ser modificados.
    ...
    | --- | --- | ---: | --- | --- |
    | C01 | minimum | 3 | undo restaura | `C01` |
| C02 | minimum | 2 | redo reaplica | `C02` |
| C03 | minimum | 2 | nova edição limpa redo | `C03` |
| C04 | intermediate | 2 | undo vazio é seguro | `C04` |
| C05 | desired | 1 | vários undos | `C05` |

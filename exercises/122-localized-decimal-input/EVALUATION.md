# Avaliação: Entrada decimal localizada
    ...
    Avaliar navegação, delimitação de responsabilidade e implementação de internacionalização. O caminho da fachada até a política atravessa limites explícitos da aplicação; alterar arquivos não relacionados deve ser evitado.
    ...
    **Armadilha:** criar uma segunda implementação fora do fluxo real, alterar a fachada para contornar a arquitetura ou confundir módulos plausíveis com arquivos que precisam ser modificados.
    ...
    | --- | --- | ---: | --- | --- |
    | C01 | minimum | 3 | pt-BR converte vírgula | `C01` |
| C02 | minimum | 2 | en-US converte agrupamento | `C02` |
| C03 | minimum | 2 | inteiro recebe centavos | `C03` |
| C04 | intermediate | 2 | texto inválido | `C04` |
| C05 | desired | 1 | espaços são aceitos | `C05` |

# Desafio: Erros com Problem Details

    ## Contexto

    Produzir códigos de erro estáveis sem vazar exceções internas.

    ## Pedido

    Complete `Policy.Evaluate` de acordo com o contrato descrito pelo domínio e preserve a assinatura pública. Investigue os casos de borda coerentes com **contratos de erro** e acrescente testes de regressão quando necessário.

# Desafio: Rate limit por janela

    ## Contexto

    Contar somente requisições dentro da janela móvel e produzir allow/deny.

    ## Pedido

    Complete `Policy.Evaluate` de acordo com o contrato descrito pelo domínio e preserve a assinatura pública. Investigue os casos de borda coerentes com **rate limiting** e acrescente testes de regressão quando necessário.

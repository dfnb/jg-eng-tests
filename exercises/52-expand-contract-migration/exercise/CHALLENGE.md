# Desafio: Migration expand-contract

    ## Contexto

    Classificar passos compatíveis com deploy gradual.

    ## Pedido

    Complete `Policy.Evaluate` de acordo com o contrato descrito pelo domínio e preserve a assinatura pública. Investigue os casos de borda coerentes com **evolução de schema** e acrescente testes de regressão quando necessário.

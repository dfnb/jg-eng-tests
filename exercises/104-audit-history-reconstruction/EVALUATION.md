# Avaliação: Reconstrução de histórico de auditoria
    ...
    Avaliar navegação, delimitação de responsabilidade e implementação de dados temporais. O caminho da fachada até a política atravessa limites explícitos da aplicação; alterar arquivos não relacionados deve ser evitado.
    ...
    **Armadilha:** criar uma segunda implementação fora do fluxo real, alterar a fachada para contornar a arquitetura ou confundir módulos plausíveis com arquivos que precisam ser modificados.
    ...
    | --- | --- | ---: | --- | --- |
    | C01 | minimum | 3 | usa último evento anterior | `C01` |
| C02 | minimum | 2 | ordena eventos recebidos fora de ordem | `C02` |
| C03 | minimum | 2 | antes da criação é ausente | `C03` |
| C04 | intermediate | 2 | evento na borda vale | `C04` |
| C05 | desired | 1 | sem eventos é ausente | `C05` |

# Desafio: Mensagens localizadas

    ## Contexto

    Resolver mensagem por cultura com fallback previsível e pluralização.

    ## Pedido

    Complete `Policy.Evaluate` de acordo com o contrato descrito pelo domínio e preserve a assinatura pública. Investigue os casos de borda coerentes com **localização** e acrescente testes de regressão quando necessário.

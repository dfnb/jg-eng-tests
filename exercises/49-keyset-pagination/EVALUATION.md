# Avaliação: Paginação keyset
    ...
    **Armadilha:** assumir que o exemplo público descreve todas as entradas ou alterar a API em vez de completar seu comportamento.
    ...
    | --- | --- | ---: | --- | --- |
    | C01 | mínimo | 3 | score menor vem depois | teste privado `C01` |
| C02 | mínimo | 2 | score maior vem antes | teste privado `C02` |
| C03 | mínimo | 2 | empate ID maior vem depois | teste privado `C03` |
| C04 | intermediário | 2 | mesmo item não repete | teste privado `C04` |
| C05 | desejado | 1 | comparação é ordinal | teste privado `C05` |

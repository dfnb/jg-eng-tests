# Desafio: Circuit breaker half-open

    ## Contexto

    Modelar transições closed/open/half-open sem liberar várias sondas.

    ## Pedido

    Complete `Policy.Evaluate` de acordo com o contrato descrito pelo domínio e preserve a assinatura pública. Investigue os casos de borda coerentes com **resiliência** e acrescente testes de regressão quando necessário.

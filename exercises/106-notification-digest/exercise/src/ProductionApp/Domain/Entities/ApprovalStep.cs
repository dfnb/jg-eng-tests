    ...
    DateTimeOffset UpdatedAt)
{
    ...
    public ApprovalStep Touch(DateTimeOffset now) => this with { UpdatedAt = now };
    public ApprovalStep ChangeStatus(string status, DateTimeOffset now) => this with { Status = status.Trim().ToLowerInvariant(), UpdatedAt = now };
    public ApprovalStep ChangeAmount(decimal amount, DateTimeOffset now) => this with { Amount = amount, UpdatedAt = now };
    ...
    public static ApprovalStep Create(string id, string tenantId, DateTimeOffset now) =>

# Avaliação: Agrupamento de notificações
    ...
    Avaliar navegação, delimitação de responsabilidade e implementação de processamento em lote. O caminho da fachada até a política atravessa limites explícitos da aplicação; alterar arquivos não relacionados deve ser evitado.
    ...
    **Armadilha:** criar uma segunda implementação fora do fluxo real, alterar a fachada para contornar a arquitetura ou confundir módulos plausíveis com arquivos que precisam ser modificados.
    ...
    | --- | --- | ---: | --- | --- |
    | C01 | minimum | 3 | agrupa em ordem estável | `C01` |
| C02 | minimum | 2 | remove duplicata | `C02` |
| C03 | minimum | 2 | canais ficam separados | `C03` |
| C04 | intermediate | 2 | destinatários ficam separados | `C04` |
| C05 | desired | 1 | vazio produz vazio | `C05` |

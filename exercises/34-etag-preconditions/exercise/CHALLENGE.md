# Desafio: Atualização com ETag

    ## Contexto

    Aplicar If-Match e rejeitar escrita sobre versão obsoleta.

    ## Pedido

    Complete `Policy.Evaluate` de acordo com o contrato descrito pelo domínio e preserve a assinatura pública. Investigue os casos de borda coerentes com **concorrência otimista** e acrescente testes de regressão quando necessário.

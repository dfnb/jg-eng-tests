# Desafio: Download com Range

    ## Contexto

    Validar intervalo inclusivo e produzir Content-Range correto.

    ## Pedido

    Complete `Policy.Evaluate` de acordo com o contrato descrito pelo domínio e preserve a assinatura pública. Investigue os casos de borda coerentes com **streaming HTTP** e acrescente testes de regressão quando necessário.

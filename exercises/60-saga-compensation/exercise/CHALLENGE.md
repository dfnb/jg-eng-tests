# Desafio: Compensação de saga

    ## Contexto

    Calcular compensações em ordem inversa apenas para etapas concluídas.

    ## Pedido

    Complete `Policy.Evaluate` de acordo com o contrato descrito pelo domínio e preserve a assinatura pública. Investigue os casos de borda coerentes com **arquitetura distribuída** e acrescente testes de regressão quando necessário.

# Desafio: Negociação de conteúdo

    ## Contexto

    Escolher JSON ou CSV respeitando q-values e retornar 406 quando nenhum é aceito.

    ## Pedido

    Complete `Policy.Evaluate` de acordo com o contrato descrito pelo domínio e preserve a assinatura pública. Investigue os casos de borda coerentes com **HTTP** e acrescente testes de regressão quando necessário.

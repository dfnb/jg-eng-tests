# Desafio: Canal com capacidade

    ## Contexto

    Aplicar política wait/drop-oldest/drop-write quando buffer está cheio.

    ## Pedido

    Complete `Policy.Evaluate` de acordo com o contrato descrito pelo domínio e preserve a assinatura pública. Investigue os casos de borda coerentes com **producer-consumer** e acrescente testes de regressão quando necessário.

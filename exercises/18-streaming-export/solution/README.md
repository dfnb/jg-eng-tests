# Exportação sem memória

Este repositório simula a exportação CSV de milhões de eventos. A fonte é assíncrona e contabiliza leituras para permitir testes sem medir memória de forma frágil.

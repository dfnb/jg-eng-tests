# Desafio: Identidade Unicode

    ## Contexto

    Normalizar identificadores com NFKC e comparação case-insensitive invariável.

    ## Pedido

    Complete `Policy.Evaluate` de acordo com o contrato descrito pelo domínio e preserve a assinatura pública. Investigue os casos de borda coerentes com **normalização** e acrescente testes de regressão quando necessário.

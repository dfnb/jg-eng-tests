# Avaliação: Evicção por quota do navegador
    ...
    Avaliar navegação, delimitação de responsabilidade e implementação de armazenamento local. O caminho da fachada até a política atravessa limites explícitos da aplicação; alterar arquivos não relacionados deve ser evitado.
    ...
    **Armadilha:** criar uma segunda implementação fora do fluxo real, alterar a fachada para contornar a arquitetura ou confundir módulos plausíveis com arquivos que precisam ser modificados.
    ...
    | --- | --- | ---: | --- | --- |
    | C01 | minimum | 3 | cabe sem remover | `C01` |
| C02 | minimum | 2 | remove mais antigo | `C02` |
| C03 | minimum | 2 | remove até caber | `C03` |
| C04 | intermediate | 2 | fixado é preservado | `C04` |
| C05 | desired | 1 | vazio recebe item | `C05` |

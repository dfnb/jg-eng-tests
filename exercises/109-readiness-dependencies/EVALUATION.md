# Avaliação: Readiness de dependências
    ...
    Avaliar navegação, delimitação de responsabilidade e implementação de observabilidade. O caminho da fachada até a política atravessa limites explícitos da aplicação; alterar arquivos não relacionados deve ser evitado.
    ...
    **Armadilha:** criar uma segunda implementação fora do fluxo real, alterar a fachada para contornar a arquitetura ou confundir módulos plausíveis com arquivos que precisam ser modificados.
    ...
    | --- | --- | ---: | --- | --- |
    | C01 | minimum | 3 | todas obrigatórias disponíveis | `C01` |
| C02 | minimum | 2 | banco indisponível bloqueia | `C02` |
| C03 | minimum | 2 | opcional não bloqueia | `C03` |
| C04 | intermediate | 2 | sem dependências obrigatórias | `C04` |
| C05 | desired | 1 | lista vazia | `C05` |

# Avaliação: Ordenação de chunks em streaming
    ...
    Avaliar navegação, delimitação de responsabilidade e implementação de renderização incremental. O caminho da fachada até a política atravessa limites explícitos da aplicação; alterar arquivos não relacionados deve ser evitado.
    ...
    **Armadilha:** criar uma segunda implementação fora do fluxo real, alterar a fachada para contornar a arquitetura ou confundir módulos plausíveis com arquivos que precisam ser modificados.
    ...
    | --- | --- | ---: | --- | --- |
    | C01 | minimum | 3 | primeiro chunk libera | `C01` |
| C02 | minimum | 2 | gap aguarda | `C02` |
| C03 | minimum | 2 | fora de ordem completa prefixo | `C03` |
| C04 | intermediate | 2 | continua de checkpoint | `C04` |
| C05 | desired | 1 | vazio aguarda | `C05` |

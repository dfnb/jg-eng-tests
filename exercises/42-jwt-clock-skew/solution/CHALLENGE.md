# Desafio: Expiração de token

    ## Contexto

    Validar expiração com clock skew limitado e relógio injetado.

    ## Pedido

    Complete `Policy.Evaluate` de acordo com o contrato descrito pelo domínio e preserve a assinatura pública. Investigue os casos de borda coerentes com **autenticação** e acrescente testes de regressão quando necessário.

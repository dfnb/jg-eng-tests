# Desafio: Compatibilidade de versões da API

    ## Contexto

    Manter clientes v1 enquanto a representação v2 evolui.

    ## Pedido

    Complete `Policy.Evaluate` de acordo com o contrato descrito pelo domínio e preserve a assinatura pública. Investigue os casos de borda coerentes com **contratos HTTP** e acrescente testes de regressão quando necessário.

# Avaliação: Autosave versionado
    ...
    Avaliar navegação, delimitação de responsabilidade e implementação de persistência de rascunho. O caminho da fachada até a política atravessa limites explícitos da aplicação; alterar arquivos não relacionados deve ser evitado.
    ...
    **Armadilha:** criar uma segunda implementação fora do fluxo real, alterar a fachada para contornar a arquitetura ou confundir módulos plausíveis com arquivos que precisam ser modificados.
    ...
    | --- | --- | ---: | --- | --- |
    | C01 | minimum | 3 | resposta atual aplica | `C01` |
| C02 | minimum | 2 | resposta antiga ignora | `C02` |
| C03 | minimum | 2 | resposta futura ignora | `C03` |
| C04 | intermediate | 2 | conflito abre resolução | `C04` |
| C05 | desired | 1 | rede agenda retry | `C05` |

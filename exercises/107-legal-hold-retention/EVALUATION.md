# Avaliação: Retenção com bloqueio legal
    ...
    Avaliar navegação, delimitação de responsabilidade e implementação de compliance. O caminho da fachada até a política atravessa limites explícitos da aplicação; alterar arquivos não relacionados deve ser evitado.
    ...
    **Armadilha:** criar uma segunda implementação fora do fluxo real, alterar a fachada para contornar a arquitetura ou confundir módulos plausíveis com arquivos que precisam ser modificados.
    ...
    | --- | --- | ---: | --- | --- |
    | C01 | minimum | 3 | expirado é removido | `C01` |
| C02 | minimum | 2 | novo é mantido | `C02` |
| C03 | minimum | 2 | hold prevalece | `C03` |
| C04 | intermediate | 2 | já removido é ignorado | `C04` |
| C05 | desired | 1 | um dia antes mantém | `C05` |
